...
const onSubmit = async (event) => {
  ...
  return (
    <div id='contact' className='items-center justify-center  flex flex-col gap-20 my-[70px]'>
      ...
      <div className="flex gap-[30px] w-full justify-between ">
        ...
        <form onSubmit={onSubmit} className="flex flex-col gap-[15px] items-start basis-[55%]">
            ...
            <input className='bg-[#32323c] text-lg border-none rounded-sm   w-full py-4.5 pl-5  text-[#a0a0a0] ' type="email" name='email' placeholder='Enter your email' />
        
            <label htmlFor="" className='taext[#d8d8d8] '>Write your message here</label>
            <textarea name="textarea" className='bg-[#32323c] text-lg border-none rounded-sm   w-full py-4.5 pl-5  text-[#a0a0a0] ' placeholder='Enter your message' rows={8} id=""></textarea>
            {/* <input className='bg-[#32323c] text-lg border-none rounded-sm   w-full py-4.5 pl-5  text-[#a0a0a0] ' type="text" name='name' placeholder='Enter your name' /> */}
            <button type='submit' className='text-white rounded-[50px] cursor-pointer  transition duration-300  hover:scale-104 px-[40px] py-4.5 mt-[15px] text-lg  bg-[linear-gradient(267deg,_#DA7C25_0.36%,_#B923E1_102.06%)]'>Submit Now</button>
